parameters = [
  ...
  { name = "dev.cart.redis_host", value = "http://redis-dev.naveendevops2.online:8080" },
  { name = "dev.cart.catalogue_host", value = "http://catalogue-dev.naveendevops2.online:8080" },
